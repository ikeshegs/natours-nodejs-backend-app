    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? 'http://localhost:3500/api/v1/users/updateMyPassword' : 'http://localhost:3500/api/v1/users/updateMe';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
...
var stripe = Stripe('pk_test_QFgUx1AaFDb3g0wB77arFtRF00WJiaouMU');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("http://localhost:3500/api/v1/bookings/checkout-session/".concat(tourId));
...
if (userDataForm) userDataForm.addEventListener('submit', function (e) {
  ...
  (0, _updateUserSettings.updateUserData)(form, 'data');
});
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 7;
            return (0, _updateUserSettings.updateUserData)({
